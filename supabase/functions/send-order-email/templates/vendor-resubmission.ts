// supabase/functions/send-order-email/templates/vendor-resubmission.ts
// Vendor Resubmission Required Email Template

// @ts-ignore - Deno requires .ts extension
import { getEmailHeader, getEmailFooter } from './_shared.ts'
// @ts-ignore - Deno requires .ts extension
import type { VendorResubmissionData } from '../types.ts'

export function generateVendorResubmissionEmail(data: VendorResubmissionData): string {
