            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {buyerSteps.map((step) => (
                <div key={step.step} className="relative">
                  ...
                  <div className="relative overflow-hidden rounded-2xl bg-slate-900/50 border border-white/5 p-6 hover:border-green-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/10 h-full">
                    ...
                    <div className="relative">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <span className="text-green-400 font-bold text-lg">Step {step.step}</span>
                      </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {sellerSteps.map((step) => (
                <div key={step.step} className="relative">
                  ...
                  <div className="relative overflow-hidden rounded-2xl bg-slate-900/50 border border-white/5 p-6 hover:border-purple-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 h-full">
                    ...
                    <div className="relative">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <span className="text-purple-400 font-bold text-lg">Step {step.step}</span>
                      </div>
                      <h3 className="text-xl font-bold text-white mb-3">{step.title}</h3>
                      <p className="text-gray-400 mb-4 text-sm">{step.description}</p>
                      <ul className="space-y-2">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {protectionFeatures.map((feature, idx) => (
                <div key={idx} className="bg-slate-900/30 border border-white/5 rounded-xl p-6 hover:bg-slate-800/50 hover:border-purple-500/30 transition-all duration-300 group">
                  <div className="w-14 h-14 bg-slate-900/50 border border-white/5 rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:border-purple-500/30 transition">
                    {feature.icon}
                  </div>
          ...
          <div className="container mx-auto px-4">
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="relative text-center bg-slate-900/50 border border-white/10 rounded-3xl p-12">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">48-Hour Buyer Protection</h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-white/10">
                    <div className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text text-transparent">24/7</div>
                    <div className="text-sm text-gray-500">Support Available</div>
                  </div>
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-white/10">
                    <div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">48h</div>
                    <div className="text-sm text-gray-500">Protection Window</div>
                  </div>
                </div>
              </div>
            </div>
