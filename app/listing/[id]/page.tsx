// app/listing/[id]/page.tsx - UPDATED WITH CENSORED USERNAMES IN REVIEWS

// Copy this entire file and replace your app/listing/[id]/page.tsx
  ...
  const fetchListing = async () => {
    try {
      ...
      if (!data || !data.profiles) {
        console.error('Missing listing or seller profile')
        setModalMessage({
          title: 'Listing Error',
          message: 'This listing has an invalid seller profile. Please try another listing.',
          type: 'error'
        })
        setShowModal(true)
      ...
      setModalMessage({
        ...
        message: 'Failed to load listing. Redirecting to browse...',
        type: 'error'
      })
      setShowModal(true)
      setTimeout(() => router.push('/browse'), 2000)
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            {/* Right Column - Purchase & Seller (rest of the code remains the same) */}
