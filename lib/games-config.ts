...
export const gamesConfig: GameConfig[] = [
  // MAIN GAMES (8)
  {
    ...
    seoTitle: 'Fortnite Accounts for Sale - OG Skins, Renegade Raider | From $20',
    description: 'Buy Fortnite accounts with Renegade Raider, Black Knight, and rare OG skins. Verified sellers, 5% fees, 48-hour buyer protection. Instant delivery from $20.',
  ...
  },
  {
    ...
    icon: '🎯',
    category: 'FPS',
    seoTitle: 'Valorant Accounts for Sale - Radiant, Immortal, Skins | 48Hr Protection',
    description: 'Purchase Valorant accounts with high ranks (Radiant, Immortal), exclusive skins, and Valorant Points. Trusted marketplace with 48-hour protection and 5% commission. From $15.',
  ...
  },
  {
    ...
    icon: '🚗',
    category: 'Action',
    seoTitle: 'GTA 5 Modded Accounts - $500M+, Unlock All, Cars | From $15',
    description: 'Buy GTA 5 modded accounts with $500M+ in-game money, unlock all items, rare vehicles, and max stats. Safe transactions and instant delivery. PC, Xbox, PS5 available.',
  ...
  },
  {
    ...
    description: 'Get Roblox accounts with Robux, limited items, and rare Adopt Me pets. Trusted sellers with fast delivery. Blox Fruits, MM2, and more. From $10.',
  ...
  },
  {
    ...
    description: 'Buy League of Legends smurf accounts, ranked accounts with rare skins, and Blue Essence. Instant delivery guaranteed. Level 30+, unranked to Challenger.',
  ...
  },
  {
    ...
    description: 'Buy Clash Royale accounts with max level cards, high trophies, and legendary champions. Verified sellers, buyer protection, instant delivery. Starting at $10.',
  ...
  },
  {
    ...
    description: 'Get Steam accounts with premium games and Steam game keys at discounted prices. CS2, Dota 2, Rust, and more. Secure marketplace with buyer protection. Keys from $5.',
